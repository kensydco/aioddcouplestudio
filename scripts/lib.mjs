...
export const CHARACTERS = {
  milo: { avatarId: "e9a00cac1e934e6f80bd550fd2803d10", voiceId: "F08jhUNBtlE8Gs2Bnrj1", speed: 1.15 },
  gladys: { avatarId: "5917b84d9e224e46918a61245456efbe", voiceId: "fb0de32da8c4499f9b6e27245b8794c1", speed: 0.92 }
};
export const MAX_FULL_SCREEN_EDUCATION_GRAPHICS_SECONDS = 8;
export const MAX_EPISODE_DURATION_SECONDS = 45;
...
export function validateEpisode(episode) {
  ...
  assert(episode.scenes.some((s) => s.framing === "split-screen"), "At least one scene must show Milo and Gladys together.");
